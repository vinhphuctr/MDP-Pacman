...
public class StateGamePacman implements Etat//TODO verifier hashcode, equals et clone
{
    ...
    public void addPacmanState(StateAgentPacman pacmans_state) {
        this.pacmans_states.add(pacmans_state);
    }

    public void addGhostState(StateAgentPacman ghosts_state) {
        this.ghosts_states.add(ghosts_state);
    }

    public void initPacmansStates() {
        pacmans_states = new ArrayList<StateAgentPacman>();
    }

    public void initGhostsStates() {
        ghosts_states = new ArrayList<StateAgentPacman>();
    }

    public void setStep(int t) {
        step = t;
    }
     ...
     */
    public StateAgentPacman getPacmanState(int i) {
        return (pacmans_states.get(i));
    }
     ...
     */
    public StateAgentPacman getGhostState(int i) {
        return (ghosts_states.get(i));
    }
    ...
    public String toString() {
        ...
        for (int y = 0; y < maze.getSizeY(); y++) {
            for (int x = 0; x < maze.getSizeX(); x++) {
                ...
                else if (maze.isFood(x, y)) sb.append(".");
